...
while tentativas>0: # CRIANDO WHILE PARA NÃO TER TENTATIVAS NEGATIVAS
    ...
    break # TENTEI CRIAR UM WHILE COM ESSE BREAK PARA PARAR QUANDO TENTATIVA FOR MENOR QUE 0 MAS NÃO ESTÁ FUNCIONANDO
